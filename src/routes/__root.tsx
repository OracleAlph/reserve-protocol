...
import { APP_DESCRIPTION, APP_NAME, CANONICAL_URL } from "@/lib/site";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${CANONICAL_URL}/og.jpg` },
      ...
      { name: "twitter:image", content: `${CANONICAL_URL}/og.jpg` },
    ],
    links: [
